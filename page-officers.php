 ...
 * ACM Chapter Theme — Auto-loaded by WordPress for any page with slug "officers".
...
<section class="page-hero">
    <div class="page-hero-inner">
        <span class="eyebrow"><?php echo acm_chapter_name(); ?> Leadership</span>
        <h1>Chapter Officers</h1>
        <p>Meet the volunteers who organize events, run the chapter, and keep the <?php echo acm_chapter_city(); ?> computing community connected.</p>
    </div>
</section>
...
<section class="section section-cta">
    <div class="section-inner section-inner--center">
        ...
        <p><?php echo acm_chapter_name(); ?> is entirely volunteer-run. If you're passionate about the computing community in <?php echo acm_chapter_city_area(); ?>, we'd love to hear from you.</p>
