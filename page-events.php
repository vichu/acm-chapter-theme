 ...
 * ACM Chapter Theme — Auto-loaded by WordPress for any page with slug "events".
...
<section class="page-hero">
    <div class="page-hero-inner">
        <span class="eyebrow"><?php echo acm_chapter_city_state(); ?></span>
        <h1>Events</h1>
        <p>Talks, workshops, and networking events for computing professionals in <?php echo acm_chapter_city_area(); ?>.</p>
    </div>
</section>
